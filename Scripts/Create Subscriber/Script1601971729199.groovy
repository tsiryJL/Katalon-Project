...
int legacyID = 55966258572
int IdRef = 55966258211
...
for(int i=0; i<5;i++){
	...
	selenium.type("id=_RegisterAgent_WAR_utiba_agent_portlets__f2", "${legacyID + i}")
	printf "legacy OK"
	...
	selenium.click("id=_RegisterAgent_WAR_utiba_agent_portlets_save")
	selenium.click("id=_RegisterAgent_WAR_utiba_agent_portlets__f1")
	selenium.type("id=_RegisterAgent_WAR_utiba_agent_portlets__f1", "${IdRef + i }")
	printf "Reference OK"
	selenium.click("id=content")
	selenium.click("id=_RegisterAgent_WAR_utiba_agent_portlets__f5")
